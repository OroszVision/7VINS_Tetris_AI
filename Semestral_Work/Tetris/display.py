...
class Draw:
    ...
    def __init__(self, window = Window()):
        ...
        self.heldRect = pygame.Rect(self.heldXOffset*self.window.blockSize - 5, self.heldYOffset*self.window.blockSize - 5, self.heldWidth*self.window.blockSize + 10, self.heldWidth*self.window.blockSize + 10)
        self.fontColour = (125, 125, 125) #Grey
        self.fontPath = "Semestral_Work/Tetris/font/Fairfax.ttf"
    ...
    def drawBoard(self, board):
        ...
        for x in range(self.boardXOffset*self.window.blockSize, (self.boardWidth + self.boardXOffset)*self.window.blockSize, self.window.blockSize):
            for y in range(0, self.window.height, self.window.blockSize):
                ...
                pygame.draw.rect(self.screen, "Black", square, 0)
    ...
    def drawStartScreen(self, board):
        ...
        gameFont = pygame.font.Font("Semestral_Work/Tetris/font/Fairfax.ttf", fontSize)
